...
import { PokemonList, PokemonDetails, EvolutionChain, PokemonSpecies, PokemonType } from '../interfaces/Pokemon.ts';
...
export async function fetchPokemonEvolutionChain(id: number): Promise<EvolutionChain> {
